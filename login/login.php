            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="col-md-6" style="float: right;">
                        <div class="form-group">
                            <input type="submit" value="Sign In" name="login" class="form-control btn-success" style="background: #074051; color: #fff;">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="col-lg-12">
	<center>
	<!-- <img src="" width="130px"> -->
	<p style="font-size:12px;">TKM NAVIGATOR <br> Copyright © 2023. All Rights Reserved.</p>
	</center>
</div>
